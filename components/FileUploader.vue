...
export default {
  ...
  methods: {
    ...
    handleDragDrop(event) {
      ...
      let selectedItemOrder = changeItem.attributes['itemorder'].value
    ...
    swapElement(arr, oldIndex, newIndex) {
      const copyArray = [...arr]
      const temp = copyArray[oldIndex]
      copyArray[oldIndex] = copyArray[newIndex]
      copyArray[newIndex] = temp
      return copyArray
    },
    deleteFile(index) {
